"""Acquisition and data-quality visualizations for dataset construction.

MetaboVisualizerBuilder renders the initial project overview, including sample
...
class MetaboVisualizerBuilder(visualizer_classes.BaseMetaboVisualizer):
    ...
    def plot_builder_summary_grid(self) -> object | None:
        ...
        Automatically adapts to 100% complete datasets by rendering an
        ultra-clean
